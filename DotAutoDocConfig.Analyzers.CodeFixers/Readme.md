...
## Content
### DotAutoDocConfig.Analyzers.CodeFixers
...
### DotAutoDocConfig.Analyzers.CodeFixers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [DotAutoDocConfig.Analyzers.CodeFixers.Sample.csproj](../DotAutoDocConfig.Analyzers.CodeFixers.Sample/DotAutoDocConfig.Analyzers.CodeFixers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### DotAutoDocConfig.Analyzers.CodeFixers.Tests
