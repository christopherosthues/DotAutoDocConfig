...
### DotAutoDocConfig.Analyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [DotAutoDocConfig.Analyzers.Sample.csproj](../DotAutoDocConfig.Analyzers.Sample/DotAutoDocConfig.Analyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### DotAutoDocConfig.Analyzers.Tests
